...
if __name__ == "__main__":
    ...
    selected = [309] # starting with one class
    subdir_save_folders = {}
    for subdir in selected:
        subdir_save_folder = '/home/t-akarthik/Desktop/DINO/myFinetune/epoch99/transformer_attribution/' + CLS2IDX[subdir] + '/perturbations'
        subdir_save_folders[subdir] = subdir_save_folder
        os.makedirs(subdir_save_folder)

    exp_name = "transformer_attribution"
    exp_name += '_neg' if args.neg else '_pos'
    print(exp_name)

    args.runs_dir = os.path.join(subdir_save_folders[subdir], '/{}_{}'.format(args.vis_class, args.class_id))
    # class_id here is the prediction? ^
    ...
    vis_method_dir = '/home/t-akarthik/Desktop/DINO/myFinetune/epoch99/transformer_attribution/' + CLS2IDX[subdir] + '/group1'
    # ^ start with group1 for now, then expand to groups 2 and 3?
