...
OUTPUT_VIS_DIR = ROOT_DIR + "/output/ViT/ViT_Small Visualizations/Neg"
OUTPUT_PERTURB_DIR = ROOT_DIR + "/output/ViT/ViT_Small Perturbations"
...
def perturb_all(top_vis_dict, args, subdir):
 ...
 folder_perturb = OUTPUT_PERTURB_DIR + '/True/' + str(subdir)
...
if __name__ == "__main__":
    ...
    model_new = vit_small_patch16_224(pretrained=True).cuda()
